...
- <span><img src="https://acnhcdn.com/latest/MenuIcon/Fossil.png" id="inv-icon"></span> **Fossils** can be found by digging up spots in the ground that look like X's. Bring them to Blathers to be assessed. 
...
- Upon talking to Tom Nook, he should mention something called a <span><img src="https://acnhcdn.com/latest/MenuIcon/PlaneTicket.png" id="inv-icon"></span> **Nook Miles Ticket** (often abbreviated as NMT), and give you one for free. 
...
- Since you unlocked the Nook Stop today, it may be a good idea to purchase the **tool ring** (called <span><img src="https://acnhcdn.com/latest/MenuIcon/HowtoBookExpansion.png" id="inv-icon"></span>" Tool Ring: It's Essential!"), which lets you quickly access your tools by using the D-Pad on your Switch.
- Additionally, you may want to purchase the <span><img src="https://acnhcdn.com/latest/MenuIcon/BookRecipe.png" id="inv-icon"></span> "Pretty Good Tools Recipes" pack from the Nook Stop, which will give you DIY recipes for more durable versions of the axe, shovel, fishing rod, net, and watering can.
