...
## Visit Blathers
- Blathers <span><img src="https://chibisnorlax.github.io/acnhbeginners/assets/NpcIcon/owl.png" id="inv-icon"></span> should have set up his tent in the location that you placed it. Go pay him a visit!
...
- This quest does not have to be completed in one day. In fact, it may take you awhile to gather all the materials you need. But if you want more, you're in luck, Tom Nook is going to give you a free <span><img src="https://chibisnorlax.github.io/acnhbeginners/assets/MenuIcon/PlaneTicket.png" id="inv-icon"></span> **Nook Miles Ticket**, which will allow you to visit a mystery island and gather more materials. 

## Complete your first Mystery Tour
- Upon talking to Tom Nook, he should mention something called a <span><img src="https://chibisnorlax.github.io/acnhbeginners/assets/MenuIcon/PlaneTicket.png" id="inv-icon"></span> **Nook Miles Ticket** (often abbreviated as NMT), and give you one for free. 
...
{: .note}
If you invite a villager they will not move in until you have a free plot for them which you can find information about later in this guide ([here](https://chibisnorlax.github.io/acnhbeginners/walkthrough/day%203/#new-villagers))

## What else can I do today?
- Since you unlocked the Nook Stop today, it may be a good idea to redeem the <span><img src="https://chibisnorlax.github.io/acnhbeginners/assets/MenuIcon/HowtoBookExpansion.png" id="inv-icon"></span> **Tool Ring: It's Essential!** upgrade, which lets you quickly access your tools by using the D-Pad on your Switch.
- Additionally, you may want to redeem the <span><img src="https://chibisnorlax.github.io/acnhbeginners/assets/MenuIcon/BookRecipe.png" id="inv-icon"></span> **Pretty Good Tools Recipes** pack from the Nook Stop, which will give you DIY recipes for more durable versions of the axe, shovel, fishing rod, net, and watering can.
...
<div>
  ...
  <input type="checkbox">  
    <label>Redeem <span><img src="https://chibisnorlax.github.io/acnhbeginners/assets/MenuIcon/HowtoBookExpansion.png" id="inv-icon"></span> **Tool Ring: It's Essential!**.</label> <br>
  <input type="checkbox">
    <label>Redeem <span><img src="https://chibisnorlax.github.io/acnhbeginners/assets/MenuIcon/BookRecipe.png" id="inv-icon"></span> **Pretty Good Tools Recipes**.</label> <br>
</div>
